...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_45c87cc2322a34741ae1fb42cfae3821c').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️Avirup',
  ...
  MENTION: process.env.MENTION || 'Im here',
  ...
  PERSONAL_MESSAGE: (process.env.PERSONAL_MESSAGE || 'Hii its Avi').trim(),
